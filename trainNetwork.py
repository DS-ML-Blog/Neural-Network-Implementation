...
def trainNetwork(n_inputs, n_hidden, n_outputs, n_training, input_limits, w_limits, conv):
    ...
    '''
    czas_start = dt.now()
    #  1. Inicjalizacja macierzy wag: W1, W2 i W, outputów Z, preoutputów Y oraz ujemnych gradientów G
